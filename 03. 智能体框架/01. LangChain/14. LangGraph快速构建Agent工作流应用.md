...
核心思想是先制定一个多步骤计划，然后逐项执行。完成一项特定任务后。您可以重试审视计划并根据需要进行修改。

一般的计算图如下所示

![image-20250327200913116](14. LangGraph快速构建Agent工作流应用.assets/image-20250327200913116.png)

>一般通过迭代次数防止死循环

这与典型的ReAct风格的代理进行了比较，在该代理中，您一次思考异步。这种“计划并执行”风格代理的优势在于

1. 明确的长期规划（即使是真正强大的LLM也可能难以做到）
...
![image-20250327203113748](14. LangGraph快速构建Agent工作流应用.assets/image-20250327203113748.png)
